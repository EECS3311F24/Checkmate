...
export const getGameHistory = async () => {
    try {
      const response = await axios.get('/api/chess/history');
      return response;
    } catch (error) {
  ...
  export const getGameReplay = async (gameId) => {
    try {
      const response = await axios.get(`/api/chess/replay/${gameId}`);
      return response;
    } catch (error) {
  ...
  export const saveGameResult = async (gameData) => {
    try {
      const response = await axios.post('/api/chess/save-game', gameData);
      return response;
    } catch (error) {
